<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['medicine:batch:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['medicine:batch:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['medicine:batch:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="batchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="批次id" align="center" prop="id" />
...
<script>
import { listBatch, getBatch, delBatch, addBatch, updateBatch } from "@/api/medicine/batch";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除批次编号为"' + ids + '"的数据项？').then(function() {
        return delBatch(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('medicine/batch/export', {
        ...this.queryParams
