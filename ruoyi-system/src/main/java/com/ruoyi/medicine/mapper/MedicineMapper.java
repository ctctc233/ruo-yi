...
//    public Medicine selectAllMedicines();
	 ...
	 * @return 结果
	 */
	public List<MedicinePro> outMedicineDetail(@Param("name") String name, @Param("location") String location);
	 ...
	 * @return 结果
	 */
	public int selectMedicineStock(@Param("name") String name, @Param("location") String location);
